# * Try to find GDB
#
# Once done, this will define: GDB_FOUND - system has GDB GDB_COMMAND - the
# command to run GDB_VERSION - version GDB_HAS_RETURN_CHILD_RESULT - if the
# --return-child-result flag is supported
#
# Useful configuration variables you might want to add to your cache:
# GDB_ROOT_DIR - A directory prefix to search
#
# Original Author: 2009-2010 Rylie Pavlik <rylie@ryliepavlik.com>
# https://ryliepavlik.com/ Iowa State University HCI Graduate Program/VRAC
#
...
set(GDB_ROOT_DIR
    "${GDB_ROOT_DIR}"
    CACHE PATH "Directory to start our search in")
...
if(GDB_COMMAND)
  ...
  string(REGEX REPLACE "[^0-9]*([0-9]+[0-9.]*).*" "\\1" GDB_VERSION
                       "${GDB_VERSION}")
endif()
